...
class Rule(object):
    ...
    def __init__(self, **kwargs):
        ...
        rule: A function or a string containing a command to be called.
                ...
                A function is called as func(env, [targets], [sources]) where
                ctx is the Context and targets and soures are expanded.
        ...
        for dep in deps:
            ...
            if not rule:
                ...
                if '.' in dep:
                    ...
                    r0 = self.ctx.implicit_rules.get(suffix)
                    if r0:
                        r0 = [r0]
                if not r0:
                    r0 = []
                for rl in r0 + self.ctx.implicit_rules.values():
                    for r in rl:
